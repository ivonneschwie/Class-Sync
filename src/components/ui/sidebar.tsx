        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>Access your schedule, summaries, and flashcards.</SheetDescription>
            </SheetHeader>
